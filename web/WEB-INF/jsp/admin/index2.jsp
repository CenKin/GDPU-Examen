        ...
        <div class="panel-group" id="sidebar">
            ...
            <div class="panel panel-default">
                ...
                <div id="questionMeun" class="panel-collapse collapse in">
                    <div class="panel-body">
                        <ul>
                            <li><a href="javascript:void(0)" onclick="jump('admin/toAddQuestion.action')" class="btn btn-default sidebar-child"><i class="glyphicon glyphicon-plus-sign"></i> 增加题目</a></li>
                            <li><a href="javascript:void(0)" onclick="jump('admin/toSelectQuestion.action')" class="btn btn-default sidebar-child"><i class="glyphicon glyphicon-search"></i> 高级检索</a></li>
            ...
            <div class="panel panel-default">
                ...
                <div id="courseMenu" class="panel-collapse collapse">
                    <div class="panel-body">
                        <ul>
                            <li><a href="javascript:void(0)" onclick="jump('admin/toAddCourse.action')" class="btn btn-default sidebar-child"><i class="glyphicon glyphicon-plus-sign"></i> 增加科目</a></li>
                            <li><a href="javascript:void(0)" onclick="jump('admin/toSelectCourse.action')" class="btn btn-default sidebar-child"><i class="glyphicon glyphicon-search"></i> 检索科目</a></li>
                        </ul>
                    </div>
                </div>
            </div>
